$(function() {
    var stopGame = '<audio autoplay="autoplay" src="sound.mp3" type="audio/mp3"></audio>';
    var levelUp = '<audio autoplay="autoplay" src="level_up.mp3" type="audio/mp3"></audio>';
        ...
        if(gameState == 'playing') {
            ...
            if(gameSequence[clickedNo] == selectedSquare) {
                if(clickedNo == level-1) {
                    ...
                    start.text('Go to the next level🔜');
                    $('#gameover').html(levelUp);
                    level++;
                }
